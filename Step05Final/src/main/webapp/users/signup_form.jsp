...
<body>
   <div class="container" id="app">
      ...
      <form action="signup.jsp" method="post" id="signupForm">
         ...
         <button v-bind:diabled="!idValid // !isEmailValid // !isPwdValid" class="btn btn-outline-primary" type="submit">가입</button>
         <button v-bind:diabled="!(isIdValid && isEmailValid && isPwdValid)" class="btn btn-outline-primary" type="submit">가입</button>
      </form>
   </div>
      ...
      new Vue({
         ...
         methods:{
            ...
            onPwdInput(){
               ...
               // 특수 문자가 포함 되었는지 여부를 검증할 정규 표현식
               const reg=/[\W]/;
               // 정규 표현식도 통과하고 비밀번호 입력란과 확인란도 같은지 확인해서 비밀번호 유효성 여부에 반영

	...
	<div class="container">
		...
		<form action="signup.jsp" method="post">
            ...
            <select class="form-select mb-2" id="job" name="job">
                ...
                <option value="soccer" <%=job.equals("soccer") ? "selected":"" %>>축구선수</option>
                <option value="baseball" <%=job.equals("baseball") ? "selected":"" %>>야구선수</option>
                <option value="golf" <%=job.equals("golf") ? "selected":"" %>>골프선수</option>
            </select>
            <fieldset>
                <legend>성별 체크</legend>

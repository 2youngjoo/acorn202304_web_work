...
<%
	...
	if(!dto.getWriter().equals(id)){
		// 에러 응답하기
		// HttpServletResponse.SC_FORBIDDEN = 403 오류 코드임
		response.sendError(HttpServletResponse.SC_FORBIDDEN, "남의 파일 지우면 혼난다!");
		// 메소드를 여기서 끝내기
		return;
	}
	
	// 파일 시스템에서 삭제한다.(webapp/upload 폴더에서 해당 파일 삭제)
	...
	response.sendRedirect(cPath+"/file/list.jsp"); // 파일 목록 보기로 다시 리다일렉트 이동 시킨다.
%>

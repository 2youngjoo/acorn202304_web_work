...
/*
 *   Application 전역에서 MemeberDao 객체는 오직 한개만 생성해서 사용하도록 구조를 만들어야 한다.
 *  
 *   1. 외부에서 객체 생성하지 못하도록 생성자의 접근 지정자는 private
 *   2. 자신의 참조 값을 지정할 수 있는 static 필드 만들기
 *   3. 자신의 참조 값을 리턴해주는 public 메소드 만들기 
 */
...
public class MemberDao {
	...
	public MemberDto getData(int num) {
		...
		// 회원 한명의 정보가 담긴 MemberDto 객체 리턴 해주기
		return dto;
